...
const FREQUENCY_LABEL: Record<'weekly' | 'biweekly' | 'monthly', string> = {
  weekly: 'semanal',
  biweekly: 'quincenal',
  monthly: 'mensual',
};
...
export function HistorialPageClient({
  summary,
  operations,
}: HistorialPageClientProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <LoanDetailsModal group={selectedGroup} onClose={handleCloseModal} />
    </div>
  );
}
...
function getFrequencyLabel(frequency?: 'weekly' | 'biweekly' | 'monthly') {
